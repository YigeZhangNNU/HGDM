...
def process(policy, data_loader, top_k=[1, 3, 5, 10]):
...
if __name__ == "__main__":
    ...
    model_dir = f"trained_tree/{args.problem}/{args.seed}"
    ...
    import torch
    from utilities_tree import log, FlatDataset, pad_tensor
    ...
    ## test ##
    top_k = [1, 3, 5, 10]
    test_kacc = process(policy, test_loader)
